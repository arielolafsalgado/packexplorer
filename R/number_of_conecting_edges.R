#' Gets the number of conecting edges between two groups
#'
...
#' @param mode The direction of the edges to be considered. If 'in', the edges considered will be incident over group1, if 'out', will be incident over group2, if 'all', all edges are considered.
#' @export
